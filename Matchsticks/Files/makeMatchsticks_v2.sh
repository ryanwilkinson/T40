...
sleep 1
# 0.15V matchstick
voltage=$(echo 'scale=1;15/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.25V matchstick
voltage=$(echo 'scale=1;25/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.35V matchstick
voltage=$(echo 'scale=1;35/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.45V matchstick
voltage=$(echo 'scale=1;45/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.55V matchstick
voltage=$(echo 'scale=1;55/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.65V matchstick
voltage=$(echo 'scale=1;65/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.75V matchstick
voltage=$(echo 'scale=1;75/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.85V matchstick
voltage=$(echo 'scale=1;85/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
...
sleep 1
# 0.95V matchstick
voltage=$(echo 'scale=1;95/100' | bc )
echo $voltage
printf "set amplitude $voltage\r" > /dev/ttyUSB1
sleep 1
printf "set pulse on 1\r" > /dev/ttyUSB1
